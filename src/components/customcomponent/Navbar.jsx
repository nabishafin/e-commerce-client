...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full px-2 md:px-10 bg-gray-950/10 backdrop-blur supports-[backdrop-filter]:bg-gray-900/60 shadow-sm">
      <div className="flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-4 relative">
          {/* Home */}
          <Link to={"/"}>
            <Button variant="ghost" size="sm" className="flex items-center space-x-2 text-white hover:bg-gray-100">
